...
window.addEventListener('submit-scroll:scroll-to', function (ev) {
  var _ev$detail;

  ev.stopPropagation();
  var selector = ev === null || ev === void 0 ? void 0 : (_ev$detail = ev.detail) === null || _ev$detail === void 0 ? void 0 : _ev$detail.query;
